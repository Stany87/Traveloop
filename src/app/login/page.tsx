        ...
        <div className="relative z-10 p-20 flex flex-col justify-end h-full w-full">
          ...
          >
            ...
            <p className="text-white/60 text-lg max-w-md">
              Sign in to access your curated itineraries, manage bookings, and discover new destinations.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); router.push('/dashboard'); }}>
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="#" className="text-xs text-[#e8834a] hover:text-[#f0a060] font-medium transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative group">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 text-xs text-gray-400 dark:text-white/40 bg-[#FDFDFB] dark:bg-[#0a0a0a]">Or continue with</span>
              </div>
            </div>
